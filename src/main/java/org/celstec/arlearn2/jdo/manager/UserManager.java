...
public class UserManager {
	...
	private static final String params[] = new String[] { "name", "email", "teamId", "runId", "gameId" };
	private static final String paramsNames[] = new String[] { "nameParam", "emailParam", "teamIdParam", "runIdParam", "gameIdParam" };
	private static final String types[] = new String[] { "String", "String", "String", "Long", "Long" };
...
//			ChannelNotificator.getInstance().notify(u.getEmail(), gm);
	...
	public static List<UserJDO> getUsers(PersistenceManager pm, String name, String email, String teamId, Long runId, Long gameId) {
		Query query = pm.newQuery(UserJDO.class);
		Object args[] = { name, email, teamId, runId, gameId };
	...
	public static void setStatusDeleted(long runId, String email) {
		PersistenceManager pm = PMF.get().getPersistenceManager();
		try {
			List<UserJDO> deleteList = getUsers(pm, null, email, null, runId, null);
