...
public class ResponseAsHtmlDelegator {
    ...
    private HashSet<Long> itemIdsForWhichResponsesExist = new HashSet<>();

    private TreeMap<Long, Response> responsesOrderedByTime = new TreeMap<>();
    private HashMap<Long, GeneralItem> generalItemHashMap = new HashMap<>();
    ...
    public void loadResponses(){
        responses = ResponseManager.getResponse(runId, null, userId, null, false);
